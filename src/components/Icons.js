...
export const LeetCodeIcon = ({ className, ...rest }) => (
  ...
  >
    <path
      fill="#FFA116"
      d="M3.9 12l4.6-4.6L7.2 5l-6.2 6 6.2 6 1.3-1.3zm16.9 0L17.3 7.4 16 8.7l4.6 4.6-4.6 4.6 1.3 1.3z"
    />
    <path
      fill="#2685F7"
      d="M8.9 21l1.4-1.4a5.95 5.95 0 0 1 8.4-8.4L20 9.8a7.95 7.95 0 0 0-11.3 11.3z"
    />
    <path
      fill="#FFC010"
      d="M15.1 3L13.7 4.4a5.95 5.95 0 0 1-8.4 8.4L4 9.8a7.95 7.95 0 0 0 11.3-11.3z"
    />
  </svg>
);
