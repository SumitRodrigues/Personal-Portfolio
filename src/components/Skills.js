...
const Skills = () => {
    return (
        <>
            ...
            lg:bg-circularLightLg lg:dark:bg-circularDarkLightLg
            md:bg-circularLightMd md:dark:bg-circularDarkLightMd
            sm:bg-circularLightSm sm:dark:bg-circularDarkLightSm
            '>
