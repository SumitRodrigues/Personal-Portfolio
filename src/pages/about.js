...
const about = () => {
    return (
        <>
            <Head>
                <title>SumitRodrigues | About Page</title>
                <meta name="description" content="any description" />
            </Head>
            <main className='flex w-full flex-col items-center justify-center dark:text-light'>
                <Layout className='pt-16'>
                    <AnimatedText text="Passion Feuls Purpose!" className='mb-16 lg:!text-7xl sm:!text=6xl xs:!text-4xl sm:mb-8' />
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        ...
                        <div className='absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-light' />
                            <Image src={profilePic} alt="SumitRodrigues" className='w-full h-auto rounded-2xl' 
                            priority
